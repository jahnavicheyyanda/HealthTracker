...
public class SoundFile {
    ...
    public void WriteFile(File outputFile, float startTime, float endTime)
        ...
        try {
            ...
            Log.e("healthtracker", "Failed to create the .m4a file.");
            Log.e("healthtracker", getStackTrace(e));
        }
    }
    ...
    private void DumpSamples(String fileName) {
        ...
        try {
            ...
            Log.w("healthtracker", "Failed to create the sample TSV file.");
            Log.w("healthtracker", getStackTrace(e));
        }
        // We are done here. Close the file and rewind the buffer.
        try {
            writer.close();
        } catch (Exception e) {
            Log.w("healthtracker", "Failed to close sample TSV file.");
            Log.w("healthtracker", getStackTrace(e));
        }
        mDecodedSamples.rewind();
    }
